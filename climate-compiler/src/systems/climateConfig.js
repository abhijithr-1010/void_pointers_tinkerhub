...
export const climateConfig = {
  rain: {
    ...
    palette: {
      ...
      progressBar: '#4a90d9',
      editorBg: '#0a1520',
      hudBg: 'rgba(10,21,32,0.85)',
      panelBg: 'rgba(13,26,42,0.92)',
      glowColor: '#4a90d9',
    },
    blur: '1.2px',
    textAnimation: 'drift',
  ...
  sunshine: {
    ...
    palette: {
      ...
      progressBar: '#f5a623',
      editorBg: '#110d00',
      hudBg: 'rgba(17,13,0,0.85)',
      panelBg: 'rgba(26,18,0,0.92)',
      glowColor: '#f5a623',
    },
    blur: '0px',
    textAnimation: 'sharp',
  ...
  snow: {
    ...
    palette: {
      ...
      progressBar: '#a0c4ff',
      editorBg: '#070c14',
      hudBg: 'rgba(7,12,20,0.85)',
      panelBg: 'rgba(10,15,26,0.92)',
      glowColor: '#a0c4ff',
    },
    blur: '0.5px',
  ...
  storm: {
    ...
    palette: {
      ...
      progressBar: '#7c3aed',
      editorBg: '#030305',
      hudBg: 'rgba(3,3,5,0.85)',
      panelBg: 'rgba(5,5,8,0.92)',
      glowColor: '#7c3aed',
    },
    blur: '0px',
    textAnimation: 'chaos',
